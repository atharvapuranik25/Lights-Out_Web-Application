...
$query_profiles_1 = "select * from users where role='cinematographer' and username != '$username'";
...
<div class="w3-bar w3-black w3-hide-small">
  ...
  <a href="home_page_cinematographer.php" class="w3-bar-item w3-button w3-center w3-white w3-padding-large" style="height: 59px;">Home</a>
  ...
  <a href="profile_page.php" class="w3-bar-item w3-right w3-greyscale-max"><img class="w3-circle" src="uploads/<?php echo $image; ?>" alt="Profile" style="width:43px; height:43px;"></a>
...
<div class="w3-bar w3-border">
    ...
    <a href="home_page_cinematographer.php" class="w3-bar-item w3-button w3-black">Cinematographers</a>
  </div>
  <br><br>
</div>
</head>
