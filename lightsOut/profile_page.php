...
$query3 = "select * from post where username = '$username'";
...
<div class="w3-display-container">
          ...
          <div>
            ...
            <button class="w3-button w3-grey w3-display-topright" style="width:10%; border: 2px solid; border-radius: 12px; margin-top:40px; margin-right:100px;">Upvote - <?php echo $upvotes; ?></button>
          </div>
...
<div class="w3-center">
    ...
    <a href="profile_page.php" class="w3-bar-item w3-button w3-black">Portfolio</a>
        <a href="profile_page_projects.php" class="w3-bar-item w3-button">Projects</a>
    </div>
</div>
<br>
</head>
  ...
  ?>
    ...
    <div class="w3-card w3-display-container w3-round-large" style="width: 80%; height: 250px; margin: auto;">
          <img src="posts/<?php echo $file; ?>" alt="Avatar" class="w3-display-left" style="width:200px; height:210px; margin-left: 30px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
            ...
            <h4 class="w3-display-topleft" style="margin-left: 260px; margin-top: 55px;"><?php echo $username; ?></h4>
    ...
    <video width="500" height="360" controls class="w3-display-left" style="margin-left: 30px;  box-shadow: 0 4px 8px 0 rgba(0, 0, 0, 0.2), 0 6px 20px 0 rgba(0, 0, 0, 0.19);">
      ...
      Your browser does not support the video tag.
            ...
            <h4 class="w3-display-topleft" style="margin-left: 560px; margin-right: 30px; margin-top: 55px;"><?php echo $username; ?></h4>
    ...
    <iframe src="posts/<?php echo $file; ?>#toolbar=0" width="95%" height="400px" class="w3-display-bottommiddle" style="margin-bottom:20px">
            ...
            <h4 class="w3-display-topleft" style="margin-left: 40px; margin-top: 55px;"><?php echo $username; ?></h4>
