...
//echo "<br>";
//echo "Profile Picture: $image";

$query_profiles_1 = "select * from users where role='writer' and username != '$username'";
$res_1 = mysqli_query($con,$query_profiles_1);
?>
...
<div class="w3-bar w3-black w3-hide-small">
  <a href="home_page_writer.php" class="w3-bar-item w3-circle"><img src="logo2.jpg" alt="Home Page" style="width:35px"></a>
  <a href="home_page_writer.php" class="w3-bar-item w3-button w3-center w3-white w3-padding-large" style="height: 59px;">Home</a>
  ...
  <a href="profile_page.php" class="w3-bar-item w3-right"><img class="w3-circle w3-grayscale-max" src="uploads/<?php echo $image; ?>" alt="Profile" style="width:43px; height:43px;"></a>
...
<div class="w3-bar w3-border">
    <a href="home_page_writer.php" class="w3-bar-item w3-button w3-black">Writers</a>
    <a href="home_page_director.php" class="w3-bar-item w3-button">Directors</a>
...
<?php
while($rs = mysqli_fetch_array($res_1))
{
  $email = $rs['email'];
...
?>
    ...
    <div class="w3-card w3-display-container w3-round-large" style="width: 90%; height: 190px; margin: auto;">
          ...
          <div>
            <h2 class="w3-display-topleft" style="margin-left: 200px"><a href="profile_page_2.php?username=<?php echo $username_2; ?>"><?php echo $username_2; ?></a></h2>
            <h4 class="w3-display-topmiddle" style="margin-top: 18px">Skill Level: <?php echo $skill_level; ?></h4 >
